...
public class LoginAdapter extends RecyclerView.Adapter<LoginAdapter.ViewHolder> {
    ...
    public LoginAdapter(Context context, List<String> Title, List<String> PostedBy,List<String> nids){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(context, "Clicked Item: " + langu.getText().toString(), Toast.LENGTH_SHORT).show();
